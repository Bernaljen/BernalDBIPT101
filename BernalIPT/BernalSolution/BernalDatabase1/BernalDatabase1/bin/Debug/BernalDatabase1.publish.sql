/*
Deployment script for RentRoom
...
GO
:setvar DatabaseName "RentRoom"
:setvar DefaultFilePrefix "RentRoom"
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '80a3a216-30b5-4bf1-82f3-3f43db092371')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('80a3a216-30b5-4bf1-82f3-3f43db092371')
