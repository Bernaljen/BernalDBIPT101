...
using BernalIPT101.BernalDomain.Queries;
using BernalIPT101.BernalFramework;
using BernalIPT101.BernalFramework.Commands;
using BernalIPT101.BernalFramework.Queries;
using BernalIPT101.BernalYoutubeViewer.Stores;
using BernalIPT101.BernalYoutubeViewer.ViewModels;
using BernalIPT101.BernalYoutubeViewer.HostBuilders;
using Microsoft.EntityFrameworkCore;

namespace BernalIPT101.BernalYoutubeViewer
{
    /// <summary>
